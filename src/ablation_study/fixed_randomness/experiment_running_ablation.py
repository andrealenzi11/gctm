...
from src.ablation_study.fixed_randomness.topic_modeling_ablation import GenerativeCooperativeTopicModelingAblation
...
if __name__ == '__main__':
    ...
    for NUM_TOPICS in (20,):
        ...
        print("\n >>>>>>>>>>>>>>>>>>>> GCTM")
        for model_name in (
                # "CTM-e-fixed_randomness",
                "CTM-b-fixed_randomness",
        ):

            print(f"\n  ##### Model name: {model_name} ##### \n")

            if model_name == "CTM-e-fixed_randomness":
                gctm_obj = GenerativeCooperativeTopicModelingAblation(num_topics=NUM_TOPICS,
                                                                      max_num_words=50,
                                                                      max_df=0.60,
                                                                      min_df=0.0005,
