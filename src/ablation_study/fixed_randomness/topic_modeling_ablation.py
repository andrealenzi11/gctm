...
from src.ablation_study.fixed_randomness.text_compression_without_generator_training import RandomnessTextCompressionNN


class GenerativeCooperativeTopicModelingAblation:
    """
    ...
    def __init__(
        ...
        self.dim_red_model = RandomnessTextCompressionNN(
