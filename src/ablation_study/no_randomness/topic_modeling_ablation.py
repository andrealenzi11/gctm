...
from src.ablation_study.no_randomness.text_compression_without_generator_training import TruncatedTextCompressionNN


class GenerativeCooperativeTopicModelingAblation2:
    """
    ...
    def __init__(
        ...
        self.dim_red_model = TruncatedTextCompressionNN(
